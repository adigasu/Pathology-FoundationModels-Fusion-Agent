...
| **T06** | `domain_reasoning_fallback` | `late` | `concat` | **0.8278** | -0.0013 | 0.0016 | 0.0016 | `REJECT` | Underperformed champion by -0.0013 (SE: 0.0016). |
...
| **T11** | `domain_reasoning_fallback` | `late` | `concat` | **0.8281** | -0.0027 | 0.0028 | 0.0028 | `REJECT` | Underperformed champion by -0.0027 (SE: 0.0028). |
